...
//• You need to modify the TWI_init function implemented in the I2C session to take a pointer
//to the configuration structure with type TWI_ConfigType.
